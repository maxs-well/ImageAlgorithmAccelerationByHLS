...
// ==============================================================
#ifndef __rgb2gray_mac_muladEe__HH__
#define __rgb2gray_mac_muladEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(rgb2gray_mac_muladEe) {
    ...
    SC_CTOR(rgb2gray_mac_muladEe):  simcore_mac_1_U ("simcore_mac_1_U") {
