...
// ==============================================================
#ifndef __rgb2gray_mul_mul_bkb__HH__
#define __rgb2gray_mul_mul_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(rgb2gray_mul_mul_bkb) {
    ...
    SC_CTOR(rgb2gray_mul_mul_bkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
