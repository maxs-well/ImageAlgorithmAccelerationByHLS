...
#include "rgb2gray_CONTROL_BUS_s_axi.h"
...
struct rgb2gray : public sc_module {
    ...
    rgb2gray_CONTROL_BUS_s_axi<C_S_AXI_CONTROL_BUS_ADDR_WIDTH,C_S_AXI_CONTROL_BUS_DATA_WIDTH>* rgb2gray_CONTROL_BUS_s_axi_U;
