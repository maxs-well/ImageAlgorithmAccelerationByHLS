...
architecture behav of rgb2gray is 
    ...
    "rgb2gray,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.400000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=3,HLS_SYN_FF=1433,HLS_SYN_LUT=2347,HLS_VERSION=2018_3}";
    ...
    component rgb2gray_CONTROL_BUS_s_axi IS
    generic (
...
begin
    rgb2gray_CONTROL_BUS_s_axi_U : component rgb2gray_CONTROL_BUS_s_axi
    generic map (
