...
set Interfaces {
    s_axi_CONTROL_BUS {
        ...
        registers {{0x14 rows W 0x0 "Data signal of rows" {{0 32 rows W 0 "Bit 31 to 0 Data signal of rows"}}} {0x1c cols W 0x0 "Data signal of cols" {{0 32 cols W 0 "Bit 31 to 0 Data signal of cols"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
